Description: This project implements a MapReduce pipeline on university examination data using Python. The MapReduce framework is used to extract student grades from text files and calculate the total number of students in each grade category (S, A, B, C, D, E, and F).  
Technologies Used:
Python
MapReduce Paradigm
Bash / Unix Shell
